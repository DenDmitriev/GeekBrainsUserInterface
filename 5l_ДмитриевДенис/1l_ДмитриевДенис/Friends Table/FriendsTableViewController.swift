...
class FriendsTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, FilterControlDelegate {
    ...
    var friends = [
        User(name: "Бен Кингсли",
             avatar: [UIImage(named: "Бен Кингсли")]),
        User(name: "Бенедикт Харди",
             avatar: [UIImage(named: "Бенедикт Харди")]),
        User(name: "Брайан Браун",
             avatar: [UIImage(named: "Брайан Браун")]),
        User(name: "Джек Томпсон",
             avatar: [UIImage(named: "Джек Томпсон")]),
        User(name: "Дженнифер Коннелли",
             avatar: [UIImage(named: "Дженнифер Коннелли")]),
        User(name: "Майкл Фассбендер",
             avatar: [UIImage(named: "Майкл Фассбендер")]),
        User(name: "Марион Котийяр",
             avatar: [UIImage(named: "Марион Котийяр")]),
        User(name: "Рэйчел Вайс",
             avatar: [UIImage(named: "Рэйчел Вайс")]),
        User(name: "Эмили Барклай",
             avatar: [UIImage(named: "Эмили Барклай")]),
        User(name: "Донал Глисон",
             avatar: [UIImage(named: "Донал Глисон")]),
        User(name: "Лидия Уилсон",
             avatar: [UIImage(named: "Лидия Уилсон")]),
        User(name: "Линдси Дункан",
             avatar: [UIImage(named: "Линдси Дункан")]),
        User(name: "Марго Робби",
             avatar: [ UIImage(named: "Марго Робби")]),
        User(name: "Митчелл Маллен",
             avatar: [ UIImage(named: "Митчелл Маллен")]),
        User(name: "Рене Зеллвегер",
             avatar: [UIImage(named: "Рене Зеллвегер")]),
        User(name: "Рэйчел МакАдамс",
             avatar: [UIImage(named: "Рэйчел МакАдамс")]),
        User(name: "Том Холландер",
             avatar: [UIImage(named: "Том Холландер")]),
        User(name: "Уилл Меррик",
             avatar: [UIImage(named: "Уилл Меррик")])
    ]
...
//    @IBAction func filterControlTouch(_ sender: FilterControl) {
//        print(#function)
